...
public class LocationManager implements GooglePlayServicesClient.ConnectionCallbacks, GooglePlayServicesClient.OnConnectionFailedListener, LocationListener, LocationClient.OnAddGeofencesResultListener, LocationClient.OnRemoveGeofencesResultListener {
    ...
    public void onGeofenceEnter(Geofence geofence) {
        ...
        if (challenge != null) {
            Manager.game().onPosition(challenge, geofence);
...
<<<<<<< HEAD
                    ...
                    setMockLocation(48.858598, 2.293759);
=======
                    setMockLocation(42.503052, 5.940890);
                    sleep(6000);
...
>>>>>>> all challenges working
    ...
    public void startScenario2() {
        new Thread() {
            public void run() {
                try {
                    setMockLocation(49.126486, 6.159343);
                    sleep(6000);
    ...
    public void startScenario3() {
        new Thread() {
            public void run() {
                try {
                    setMockLocation(49.132978, 6.214220);
                    sleep(6000);
