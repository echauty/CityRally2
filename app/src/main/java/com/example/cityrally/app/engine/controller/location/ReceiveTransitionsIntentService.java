...
public class ReceiveTransitionsIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        // If there's no error, get the transition type and create a notification
            ...
            if (
                ...
                for (Geofence geofence : geofences) {
                    if (Controller.getLocation() != null) {
                        if (transition == Geofence.GEOFENCE_TRANSITION_ENTER) {
                            Controller.getLocation().onGeofenceEnter(geofence);
                        } else {
                            Controller.getLocation().onGeofenceExit(geofence);
                        }
                    }
                }
                ...
                Challenge challenge = Controller.getGame().getChallengesMap().get(geofenceIds[0]);
    ...
    private void sendNotification(String transitionType, String ids) {
        ...
        Intent notificationIntent =
                new Intent(getApplicationContext(),GeoActivity.class);
    ...
    private void checkLocation() {
        ...
        if(!gps && !network && Controller.getActivity() != null) {
            final AlertDialog.Builder dialog = new AlertDialog.Builder(Controller.getActivity());
