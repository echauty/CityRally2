...
public class Text extends RectangularShape {
	...
	/**
	 * @param pText
	 * @throws OutOfCharactersException leaves this {@link org.andengine.entity.text.Text} object in an undefined state, until {@link org.andengine.entity.text.Text#setText(CharSequence)} is called again and no {@link OutOfCharactersException} is thrown.
	 */
