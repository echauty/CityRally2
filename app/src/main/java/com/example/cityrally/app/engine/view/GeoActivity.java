 ...
 */
public class GeoActivity extends Fragment {
    /*
    ...
    //private com.example.cityrally.app.engine.manager.location.SimpleGeofenceStore mPrefs;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.activity_geo, container, false);
        ...
        //mPrefs = new SimpleGeofenceStore(getView().getContext());
    ...
    public void onResume() {
        ...
        LocalBroadcastManager.getInstance(getView().getContext()).registerReceiver(mBroadcastReceiver, mIntentFilter);
        /*
        ...
        mUIGeofence1 = new SimpleGeofence(
                ...
                Double.valueOf("49.503052"),
                Double.valueOf("5.940890"),
                Float.valueOf("1500"),
        ...
        mUIGeofence2 = new SimpleGeofence(
                "2",
                // Get latitude, longitude, and radius from the UI
                Double.valueOf("49.626486"),
                Double.valueOf("6.159343"),
                Float.valueOf("1500"),
                // Set the expiration time
                GEOFENCE_EXPIRATION_IN_MILLISECONDS,
    ...
    private boolean servicesConnected() {
        ...
        int resultCode =
                GooglePlayServicesUtil.isGooglePlayServicesAvailable(getView().getContext());
        ...
        // Google Play services was not available for some reason
            ...
            Dialog dialog = GooglePlayServicesUtil.getErrorDialog(resultCode, getView().getContext(), 0);
            if (dialog != null) {
    ...
    public void onUnregisterByPendingIntentClicked(View view) {
        ...
        mGeofenceRemover.removeGeofencesByIntent(mGeofenceRequester.getRequestPendingIntent());
            ...
            Toast.makeText(getView().getContext(), R.string.remove_geofences_already_requested_error,
    ...
    public void onRegisterClicked(View view) {
        ...
        try {
            ...
            mGeofenceRequester.addGeofences(mCurrentGeofences);
            Toast.makeText(getView().getContext(), "Positions added",
                    Toast.LENGTH_LONG).show();
        } catch (UnsupportedOperationException e) {
            // Notify user that previous request hasn't finished.
            Toast.makeText(getView().getContext(), R.string.add_geofences_already_requested_error,
                        Toast.LENGTH_LONG).show();
        }
    }
    /**
