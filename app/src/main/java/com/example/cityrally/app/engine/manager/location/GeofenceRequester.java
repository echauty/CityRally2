package com.example.cityrally.app.engine.manager.location;

import android.content.Context;
import com.example.cityrally.app.R;
import com.example.cityrally.app.engine.manager.location.GeofenceUtils;
import com.example.cityrally.app.engine.manager.location.ReceiveTransitionsIntentService;
...
public class GeofenceRequester
    ...
    public GeofenceRequester(Context activity) {
        // Save the context
        mActivity = activity;
    ...
    public void onAddGeofencesResult(int statusCode, String[] geofenceRequestIds) {
        ...
        // If adding the geofences failed
            ...
            // Log an error
            Log.e(com.example.cityrally.app.engine.manager.location.GeofenceUtils.APPTAG, msg);

            // Create an Intent to broadcast to the app
            broadcastIntent.setAction(com.example.cityrally.app.engine.manager.location.GeofenceUtils.ACTION_GEOFENCE_ERROR)
                           .addCategory(com.example.cityrally.app.engine.manager.location.GeofenceUtils.CATEGORY_LOCATION_SERVICES)
                           .putExtra(com.example.cityrally.app.engine.manager.location.GeofenceUtils.EXTRA_GEOFENCE_STATUS, msg);
        }
