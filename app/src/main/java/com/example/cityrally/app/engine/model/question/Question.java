package com.example.cityrally.app.engine.model.question;
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (cb2.isChecked()) {
                            ...
                            setResult(RESULT_OK);
                            QuestionGame game = (QuestionGame) Controller.getGame().getGameWithId("question");
                            game.onResult(true);
                        }
                        else{
                            setResult(RESULT_CANCELED);
                            Toast.makeText(Controller.getActivity(), "Wrong answer :(", Toast.LENGTH_LONG).show();
                        }
                        finish();
                    }
                });
