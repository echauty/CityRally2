package com.example.cityrally.app.engine.model.flappy;
...
public class SceneManager {
	...
	public Scene createScene(){
		...
		// bird		
		float birdStartXOffset = (FlappyMainActivity.CAMERA_WIDTH / 4) - (Bird.BIRD_WIDTH / 4);
		float birdYOffset = (FlappyMainActivity.CAMERA_HEIGHT / 2) - (Bird.BIRD_HEIGHT / 4);
		...
		// you suck text		
		mYouSuckText = new Text(0, FlappyMainActivity.CAMERA_HEIGHT / 2 - 100, mResourceManager.mYouSuckFont, "You Suck!", new TextOptions(HorizontalAlign.CENTER), mContext.getVertexBufferObjectManager());
	...
	public static void centerSprite(Sprite sprite){
		sprite.setX((FlappyMainActivity.CAMERA_WIDTH / 2) - (sprite.getWidth() / 2));
		sprite.setY((FlappyMainActivity.CAMERA_HEIGHT / 2) - (sprite.getHeight() / 2));
	}
	...
	private void centerText(Text text){
		text.setX((FlappyMainActivity.CAMERA_WIDTH / 2) - (text.getWidth() / 2));
	}
}
