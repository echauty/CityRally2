package com.example.cityrally.app.engine.controller.location;
...
public class GeofenceRequester
    ...
    public void onAddGeofencesResult(int statusCode, String[] geofenceRequestIds) {
        ...
        // If adding the geofences failed
            ...
            // Log an error
            Log.e(com.example.cityrally.app.engine.controller.location.GeofenceUtils.APPTAG, msg);

            // Create an Intent to broadcast to the app
            broadcastIntent.setAction(com.example.cityrally.app.engine.controller.location.GeofenceUtils.ACTION_GEOFENCE_ERROR)
                           .addCategory(com.example.cityrally.app.engine.controller.location.GeofenceUtils.CATEGORY_LOCATION_SERVICES)
                           .putExtra(com.example.cityrally.app.engine.controller.location.GeofenceUtils.EXTRA_GEOFENCE_STATUS, msg);
        }
