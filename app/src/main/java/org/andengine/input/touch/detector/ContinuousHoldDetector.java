...
public class ContinuousHoldDetector extends HoldDetector implements IUpdateHandler {
	...
	/**
	 * When {@link org.andengine.input.touch.detector.ContinuousHoldDetector#isHolding()} this method will call through to {@link org.andengine.input.touch.detector.HoldDetector.IHoldDetectorListener#onHoldFinished(org.andengine.input.touch.detector.HoldDetector, long, int, float, float)}.
	 */
	@Override
	public void reset() {
		super.reset();
